...
<!-- ToolBar Start /////////////////////////////////////-->
	...
	<div class="container">
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="manuDate" name="manuDate" readonly="readonly" placeholder="제조일자">
		    </div>
		  </div>
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="file" class="form-control" id="fileName" name="fileImage" placeholder="상품이미지">
		    </div>
		  </div>	
